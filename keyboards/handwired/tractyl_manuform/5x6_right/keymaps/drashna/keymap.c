...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_5x6_right(
        _______, _______, _______, _______, _______, _______,                        _______, _______, _______, _______, _______, PD_JIGG,
        _______, _______, _______, _______, _______, _______,                        KC_WH_U, PM_TG(1),PM_MO(2),_______, _______, KC_ACCEL,
